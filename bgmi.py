...
bot = telebot.TeleBot('7354701187:AAH7_NvECKpKD4HfYK0ZKfhdlaXdrgmlli8')
# Owner and admin user IDs
owner_id = "1912413450"
admin_ids = ["1912413450" "1912413450"]
...
def send_welcome(message):
    response = (
        f"🌟 Welcome to the Patil DDOS Bot! 🌟\n\n"
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /attack command. "
                    ...
                    "🌟THE ONLY OWNER IS @Patil9200 DM TO BUY ACCESS")
